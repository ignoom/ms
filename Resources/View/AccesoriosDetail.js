function mainWindow(title, data) {
	...
	var photo = Ti.UI.createImageView({
		image:"http://msmotorsports.mx/photo/accesorios/thumbs/" + Ti.Network.encodeURIComponent(data.nombre) + ".jpg",
  		width:"auto",
	...
	photoHolder.addEventListener('click',showDetails);
